        ...
        <>
            {
                isLoading ? <div className='flex justify-center items-center h-screen '>
                    ...
                    <div className='min-h-screen bg-slate-200'>
                        ...
                        {
                            candidate ? candidate.map(item => <div className='bg-slate-200 my-4 h-full sm:p-4 mx-4 '>
                                <div key={item._id}>
                                    ...
                                    <div className='p-1 sm:p-4 md:p-4 bg-slate-300 rounded-md '>
                                        ...
                                        <p
                                            className=' font-semibold '>Status:<span className={` mx-2 text-base font-semibold text-black `}>{item.status}</span> </p>
                                        <p
                                            className=' font-semibold '>Admin :<span className={` mx-2 text-base font-medium text-black`}>{item.adminAction}</span> </p>
                                        <p
                                            className=' font-semibold '>Time of Update :<span className={` mx-2 text-base font-normal text-black`}> {new Date(item.updatedAt).toLocaleString()}</span> </p>
