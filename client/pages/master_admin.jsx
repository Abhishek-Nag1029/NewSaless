      ...
      {isAuthorized ? (
        <div className="min-h-screen bg-slate-100 w-full  ">
          <div className="flex justify-between items-center gap-2 p-3 text-white bg-slate-800">
            <div>
              <p className="text-lg  p-2 rounded-md  border border-dashed">
                Master Admin
              </p>
            </div>
            <div className="flex justify-end items-center gap-2 p-3 cursor-pointer">
              <p
                className={`${
                  toggle === "register" ? "text-blue-600 text-lg" : "text-white"
                }`}
                onClick={(e) => setToggle("register")}
              >
                Register
              </p>
              <p
