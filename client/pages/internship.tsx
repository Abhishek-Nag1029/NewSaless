          ...
          <form>
            <div className='h-full sm:h-[20rem] md:h-[25rem] w-[20rem] sm:w-[25rem] md:w-[30rem] flex flex-col justify-center gap-4 border-2 rounded-md bg-white p-4'>
              <p className='text-lg md:text-2xl font-semibold'>
                Student Partner <span className='text-green-500'>Internship</span> Program
              </p>
              <p className='font-medium text-xs md:text-base'>
                Enter your referral code in the box below to share your details and get your stipend
              </p>
              <div>
                <input
                  type="text"
              ...
              <div>
                <button type='submit' className='w-full bg-pink-400 text-black text-xs md:text-base p-2 rounded-md'>
                  Click here to share your payment details
                </button>
              </div>
