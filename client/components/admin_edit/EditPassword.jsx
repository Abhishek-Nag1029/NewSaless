    ...
    try {
      if (status === undefined) {
        const response = await axios.post(
          `https://newsaless-2.onrender.com/api/admin/checkpass-pass/${params.id}`,
          passData
        );
        setStatus(200);
      ...
      if (status == 200) {
        const response = await axios.put(
          `https://newsaless-2.onrender.com/api/admin/passupdate/${params.id}`,
          passData
        );
      ...
      <div className="h-full flex flex-col justify-between">
        ...
        <form onSubmit={(e) => handlePassSubmit(e)}>
          <div className=" p-3">
            {status === undefined ? (
              <div className="my-2">
                <label className="md: text-lg" htmlFor="currPass">
            ...
            {status === 200 ? (
              <div>
                <div className="my-2">
                  <label className="md: text-lg" htmlFor="newPass">
